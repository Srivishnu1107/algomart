                    ...
                    <div className="flex flex-col gap-6">
                        {order.orderItems.map((item, index) => (
                            <div key={index} className="flex items-center gap-4">
                                <Link href={`/product/${item.product.id}`} className="block w-20 aspect-square bg-slate-100 flex items-center justify-center rounded-md hover:bg-slate-200 transition">
                                    <Image
                                ...
                                <div className="flex flex-col justify-center text-sm">
                                    <Link href={`/product/${item.product.id}`}>
                                        <p className="font-medium text-slate-600 text-base hover:text-green-500 transition">{item.product.name}</p>
                                    </Link>
